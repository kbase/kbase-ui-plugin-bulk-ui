System.register(['@angular/core', '@angular/router', '../services/ftp.service', '../services/kbase-integration.service', '../services/kbase-auth.service', '../grid/dataTable', '../grid/dataTable.service'], function(exports_1, context_1) {
    ...
    var core_1, router_1, ftp_service_1, kbase_integration_service_1, kbase_auth_service_1, dataTable_1, dataTable_service_1;
    var cssTemplate, htmlTemplate, FileTableComponent;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
...
`;
            ...
            FileTableComponent = __decorate([
                ...
                __metadata('design:paramtypes', [router_1.ActivatedRoute, ftp_service_1.FtpService, core_1.ChangeDetectorRef, kbase_auth_service_1.KBaseAuth, kbase_integration_service_1.KBaseIntegration])
            ], FileTableComponent);
